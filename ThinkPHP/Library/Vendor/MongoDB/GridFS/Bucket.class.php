...
namespace Vendor\MongoDB\GridFS;
...
use Vendor\MongoDB\GridFS\Exception\CorruptFileException;
use Vendor\MongoDB\GridFS\Exception\FileNotFoundException;
...
class Bucket
{
    ...
    public function getFileDocumentForStream($stream)
    {
        ...
        return \vendor\MongoDB\Functions::apply_type_map_to_document($file, $this->typeMap);
    }
    ...
    public function getFileIdForStream($stream)
    {
        ...
        $file = \vendor\MongoDB\Functions::apply_type_map_to_document($file, $typeMap);
