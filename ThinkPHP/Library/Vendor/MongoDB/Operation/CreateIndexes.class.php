...
use Vendor\MongoDB\Model\IndexInput;
...
class CreateIndexes implements Executable
{
    ...
    {
        if ($this->isCollationUsed && ! \Vendor\MongoDB\Functions::server_supports_feature($server, self::$wireVersionForCollation)) {
        ...
        if (\Vendor\MongoDB\Functions::server_supports_feature($server, self::$wireVersionForCommand)) {
