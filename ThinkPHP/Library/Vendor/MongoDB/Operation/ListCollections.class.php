...
use Vendor\MongoDB\Model\CollectionInfoCommandIterator;
use Vendor\MongoDB\Model\CollectionInfoIterator;
use Vendor\MongoDB\Model\CollectionInfoLegacyIterator;
...
class ListCollections implements Executable
{
    ...
    {
        return \Vendor\MongoDB\Functions::server_supports_feature($server, self::$wireVersionForCommand)
